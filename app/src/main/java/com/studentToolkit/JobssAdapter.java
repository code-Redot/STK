...
public class JobssAdapter extends RecyclerView.Adapter<JobssAdapter.ViewHolder> {

    private Context context;
    private List<Job_Class> events_classes;


    public JobssAdapter(Context context, List<Job_Class> events_classes) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Job_Class events=events_classes.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Toast.makeText(context,club.getId(),Toast.LENGTH_SHORT).show();
                ...
                intent.putExtra("job_id",events.getId());
