...
public class ClubsAdapter extends RecyclerView.Adapter<ClubsAdapter.ViewHolder> {
    ...
    public ClubsAdapter(Context context, List<Clubs_class> clubs_classes,String prev) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(prev.equals("list")) {
                    intent = new Intent(context, Club.class);
                }
                else {
                    intent = new Intent(context, ClubsApprove.class);
                }
