...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    private List<News_class> news_classes;


    public NewsAdapter(Context context, List<News_class> news_classes) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        News_class news=news_classes.get(position);
        holder.name.setText(news.getName());
        Glide.with(context).load(news.getLogo()).into(holder.profile);
        holder.desc.setText(news.getDescripe());
